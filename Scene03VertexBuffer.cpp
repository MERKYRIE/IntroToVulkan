...
void Scene03TriangleVertexBuffer::Load(Renderer& renderer) {
    ...
    transferData[3] = PositionColorVertex {  0.5, -0.5, 0, 255, 255, 0  , 255 };
    transferData[4] = PositionColorVertex { -0.5, +0.5, 0, 0  , 255, 255, 255 };
    transferData[5] = PositionColorVertex { +0.5, +0.5, 0, 255, 0  , 255, 255 };
