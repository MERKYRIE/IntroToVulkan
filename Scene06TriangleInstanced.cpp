...
void Scene06TriangleIndexed::Load(Renderer& renderer) {
    ...
    SDL_GPUBufferCreateInfo vertexBufferCreateInfo = {
        ...
        .size = sizeof(PositionColorVertex) * 3 * 2
    };
    ...
    Uint16* indexData = reinterpret_cast<Uint16*>(&transferData[vertexBufferCreateInfo.size / sizeof(PositionColorVertex)]);
    indexData[0] = 0;
    indexData[1] = 4;
    indexData[2] = 1;
    indexData[3] = 1;
    ...
    SDL_GPUTransferBufferLocation transferIndexBufferLocation {
        .transfer_buffer = transferBuffer,
        .offset = vertexBufferCreateInfo.size
    };
    SDL_GPUBufferRegion indexBufferRegion {
        .buffer = indexBuffer,
        .offset = 0,
        .size = indexBufferCreateInfo.size
    };
